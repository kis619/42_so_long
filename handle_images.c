...
/*   Updated: 2022/03/06 16:59:34 by kmilchev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_pics	load_images(mlx_shit *mlx_s)
{
	...
	images.img1 = mlx_xpm_file_to_image(mlx_s->mlx,
			"images/size_w40_h40/wall.xpm", &images.img_width, &images.img_height);
	images.img2 = mlx_xpm_file_to_image(mlx_s->mlx,
			"images/size_w40_h40/floor.xpm", &images.img_width, &images.img_height);
	images.img3 = mlx_xpm_file_to_image(mlx_s->mlx,
			"images/size_w40_h40/collectible.xpm", &images.img_width, &images.img_height);
	images.img4 = mlx_xpm_file_to_image(mlx_s->mlx,
			"images/size_w40_h40/door.xpm", &images.img_width, &images.img_height);
	images.img5 = mlx_xpm_file_to_image(mlx_s->mlx,
			"images/size_w40_h40/player.xpm", &images.img_width, &images.img_height);
